...
class KTBootstrapDefault:
    ...
    def initAssets(context):
        ...
        # KTTheme.addJavascriptFile('js/custom/intro.js')
    ...
    def initDarkSidebarLayout(context):
        ...
        KTTheme.addHtmlAttribute(
            'body', 'data-kt-app-sidebar-hoverable', 'true')
        KTTheme.addHtmlAttribute(
            'body', 'data-kt-app-sidebar-push-header', 'true')
        KTTheme.addHtmlAttribute(
            'body', 'data-kt-app-sidebar-push-toolbar', 'true')
        KTTheme.addHtmlAttribute(
            'body', 'data-kt-app-sidebar-push-footer', 'true')
