  ...
  return (
    <div className="flex justify-center mt-8 animate-fade-in">
      {isPaper ? (
        <button
          onClick={onClick}
          className="text-white text-base md:text-lg uppercase text-center leading-[1.25] px-[30px] md:px-10 py-5 hover:brightness-110 active:scale-[0.98] transition-all"
          style={{
